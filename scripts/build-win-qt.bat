...
python -m PyInstaller --onefile --windowed ^
    ...
    --hidden-import conv.gui_qt ^
    --hidden-import conv.gui_qt.app ^
    --hidden-import conv.gui_qt.theme ^
    --hidden-import conv.gui_qt.i18n ^
    --hidden-import conv.gui_qt.about ^
    --hidden-import conv.gui_qt.controllers.conversion ^
    --hidden-import conv.gui_qt.widgets.file_table ^
    --hidden-import conv.gui_qt.widgets.params ^
    --hidden-import conv.gui_qt.widgets.preview ^
    --hidden-import conv.gui_qt.widgets.timeline ^
    --hidden-import PySide6.QtMultimedia ^
    --hidden-import PySide6.QtMultimediaWidgets ^
    --collect-data PySide6 ^
    --collect-binaries PySide6 ^
    --collect-all pillow_heif ^
    scripts\entry_gui_qt.py
